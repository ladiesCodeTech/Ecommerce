...
class CellphoneCatScreen extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              GridView.count(
                ...
                shrinkWrap: true,
                children: [
                  for (int i = 0; i < cellphoneProducts.length; i++)
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  height: 20,
                                  decoration: BoxDecoration(
                                      color: cellphoneProducts[i].isFavourite
                                          ? Color(0xFFFFEEED) // se true
                                          : Color(0xFFF4F4F4), // se false
                                      shape: BoxShape.circle),
                                  child: Icon(
                                    cellphoneProducts[i].isFavourite
                                        ? Icons.favorite
                            ...
                            SizedBox(
                              ...
                              child: AspectRatio(
                                aspectRatio: 1.2,
                                child: Image.asset(cellphoneProducts[i].images),
                              ),
                            ),
                            ...
                            Container(
                              ...
                              alignment: Alignment.centerLeft,
                              child: Text(
                                'R\$ ${cellphoneProducts[i].price.toStringAsFixed(2)}',
                                style: TextStyle(
                                    fontSize: 16,
                            ...
                            Container(
                              ...
                              child: RatingBarIndicator(
                                rating: cellphoneProducts[i].rating,
